    ...
    <div className="max-w-2xl mx-auto">
      <div className="rounded-2xl p-8 bg-gradient-to-br from-blue-50 to-white text-black shadow-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">Booked on December 28, 2024 at 4:33 PM IST</p>
        </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-gray-800">{result.flightNumber}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Booking ID</span>
                <span className="font-medium text-gray-800">{result.flightId}</span>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-800 mb-4">Passenger Information</h2>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Name</span>
                <span className="font-medium text-gray-800">{result.passengerName}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Email</span>
                <span className="font-medium text-gray-800">{result.passengerEmail}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Phone</span>
                <span className="font-medium text-gray-800">{result.passengerPhone}</span>
              </div>
            </div>
          </div>
        </div>
